...
/**
 * Base class of Model\ArticleInformation document.
 */
abstract class ArticleInformation extends \Mongator\Document\Document
{
     ...
     *
     * @return \Model\ArticleInformation The document (fluent interface).
     */
    ...
    public function processOnDelete()
    {
        ...
        $criteria = array('information' => $this->getId());
        $update = array('$unset' => array('information' => 1));
    ...
    /**
     * Returns the "article" relation one.
     *
     * @return \Model\Article The "article" relation one.
     */
    public function getArticle()
    {
        return $this->getMongator()->getRepository('Model\Article')->createQuery(array('information' => $this->getId()))->one();
    }
