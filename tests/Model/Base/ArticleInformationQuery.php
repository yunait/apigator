...
/**
 * Base class of query of Model\ArticleInformation document.
 */
abstract class ArticleInformationQuery extends \Mongator\Query\Query
{
     ...
     *
     * @return Model\ArticleInformationQuery The query with added criteria (fluent interface).
     */
