...
/**
 * Base class of repository of Model\ArticleInformation document.
 */
abstract class ArticleInformationRepository extends \Mongator\Repository
{
    ...
    {
        $this->documentClass = 'Model\ArticleInformation';
        $this->isFile = false;
        $this->collectionName = 'model_articleinformation';
