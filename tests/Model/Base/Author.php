...
/**
 * Base class of Model\Author document.
 */
abstract class Author extends \Mongator\Document\Document
{
     ...
     *
     * @return \Model\Author The document (fluent interface).
     */
    ...
    public function processOnDelete()
    {
        ...
        $this->processOnDeleteCascade('Model\Article', array('author' => $this->getId()));
    }
    ...
    /**
     * Returns the "articles" relation many-one.
     *
     * @return \Mongator\Query\Query The "articles" relation many-one.
     */
    public function getArticles()
    {
        return $this->getMongator()->getRepository('Model\Article')->createQuery(array('author' => $this->getId()));
    }
