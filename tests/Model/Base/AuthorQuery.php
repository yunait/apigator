...
/**
 * Base class of query of Model\Author document.
 */
abstract class AuthorQuery extends \Mongator\Query\Query
{
     ...
     *
     * @return Model\AuthorQuery The query with added criteria (fluent interface).
     */
