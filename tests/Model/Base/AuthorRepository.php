...
/**
 * Base class of repository of Model\Author document.
 */
abstract class AuthorRepository extends \Mongator\Repository
{
    ...
    {
        $this->documentClass = 'Model\Author';
        $this->isFile = false;
        $this->collectionName = 'model_author';
