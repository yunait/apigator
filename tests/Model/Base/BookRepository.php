...
/**
 * Base class of repository of Model\Book document.
 */
abstract class BookRepository extends \Mongator\Repository
{
    ...
    {
        $this->documentClass = 'Model\Book';
        $this->isFile = false;
        $this->collectionName = 'model_book';
