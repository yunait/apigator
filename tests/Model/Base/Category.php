...
/**
 * Base class of Model\Category document.
 */
abstract class Category extends \Mongator\Document\Document
{
     ...
     *
     * @return \Model\Category The document (fluent interface).
     */
    ...
    public function processOnDelete()
    {
        ...
        $criteria = array();
        $update = array('$pull' => array('categories' => $this->getId()));
    ...
    /**
     * Returns the "articles" relation many-many.
     *
     * @return \Mongator\Query\Query The "articles" relation many-many.
     */
    public function getArticles()
    {
        return $this->getMongator()->getRepository('Model\Article')->createQuery(array('categories' => $this->getId()));
    }
