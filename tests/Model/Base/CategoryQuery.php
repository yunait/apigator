...
/**
 * Base class of query of Model\Category document.
 */
abstract class CategoryQuery extends \Mongator\Query\Query
{
     ...
     *
     * @return Model\CategoryQuery The query with added criteria (fluent interface).
     */
