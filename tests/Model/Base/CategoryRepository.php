...
/**
 * Base class of repository of Model\Category document.
 */
abstract class CategoryRepository extends \Mongator\Repository
{
    ...
    {
        $this->documentClass = 'Model\Category';
        $this->isFile = false;
        $this->collectionName = 'model_category';
