...
/**
 * Base class of query of Model\ConnectionGlobal document.
 */
abstract class ConnectionGlobalQuery extends \Mongator\Query\Query
{
     ...
     *
     * @return Model\ConnectionGlobalQuery The query with added criteria (fluent interface).
     */
    public function findByField($value)
    {
        ...
        return $this->mergeCriteria(array('field' => $castValue ));
    }
}