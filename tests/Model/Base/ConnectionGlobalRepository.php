...
/**
 * Base class of repository of Model\ConnectionGlobal document.
 */
abstract class ConnectionGlobalRepository extends \Mongator\Repository
{
    ...
    {
        $this->documentClass = 'Model\ConnectionGlobal';
        $this->isFile = false;
        $this->connectionName = 'global';
        $this->collectionName = 'model_connectionglobal';
