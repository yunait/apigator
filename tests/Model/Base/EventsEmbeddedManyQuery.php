...
/**
 * Base class of query of Model\EventsEmbeddedMany document.
 */
abstract class EventsEmbeddedManyQuery extends \Mongator\Query\Query
{
     ...
     *
     * @return Model\EventsEmbeddedManyQuery The query with added criteria (fluent interface).
     */
