...
/**
 * Base class of repository of Model\EventsEmbeddedMany document.
 */
abstract class EventsEmbeddedManyRepository extends \Mongator\Repository
{
    ...
    {
        $this->documentClass = 'Model\EventsEmbeddedMany';
        $this->isFile = false;
        $this->collectionName = 'model_eventsembeddedmany';
