...
/**
 * Base class of query of Model\EventsEmbeddedOne document.
 */
abstract class EventsEmbeddedOneQuery extends \Mongator\Query\Query
{
     ...
     *
     * @return Model\EventsEmbeddedOneQuery The query with added criteria (fluent interface).
     */
