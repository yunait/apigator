...
/**
 * Base class of repository of Model\EventsEmbeddedOne document.
 */
abstract class EventsEmbeddedOneRepository extends \Mongator\Repository
{
    ...
    {
        $this->documentClass = 'Model\EventsEmbeddedOne';
        $this->isFile = false;
        $this->collectionName = 'model_eventsembeddedone';
