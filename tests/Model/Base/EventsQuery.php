...
/**
 * Base class of query of Model\Events document.
 */
abstract class EventsQuery extends \Mongator\Query\Query
{
     ...
     *
     * @return Model\EventsQuery The query with added criteria (fluent interface).
     */
