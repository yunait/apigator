...
/**
 * Base class of repository of Model\FormElement document.
 */
abstract class FormElementRepository extends \Mongator\Repository
{
    ...
    {
        $this->documentClass = 'Model\FormElement';
        $this->isFile = false;
