...
/**
 * Base class of query of Model\IdGeneratorSingleInheritanceChild document.
 */
abstract class IdGeneratorSingleInheritanceChildQuery extends \Mongator\Query\Query
{
    ...
    public function createCursor()
    {
        ...
        $criteria = array_merge($criteria, array('type' => 'child'));
     ...
     *
     * @return Model\IdGeneratorSingleInheritanceChildQuery The query with added criteria (fluent interface).
     */
