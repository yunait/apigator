...
/**
 * Base class of repository of Model\IdGeneratorSingleInheritanceParent document.
 */
abstract class IdGeneratorSingleInheritanceParentRepository extends \Mongator\Repository
{
    ...
    {
        $this->documentClass = 'Model\IdGeneratorSingleInheritanceParent';
        $this->isFile = false;
     ...
     *
     * @return \Model\IdGeneratorSingleInheritanceGrandParent The parent repository.
     */
    public function getParentRepository()
    {
        return $this->getMongator()->getRepository('Model\IdGeneratorSingleInheritanceGrandParent');
    }
    ...
    {
        $parentClass = 'Model\IdGeneratorSingleInheritanceGrandParent';
        do {
