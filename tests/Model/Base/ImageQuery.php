...
/**
 * Base class of query of Model\Image document.
 */
abstract class ImageQuery extends \Mongator\Query\Query
{
     ...
     *
     * @return Model\ImageQuery The query with added criteria (fluent interface).
     */
