...
/**
 * Base class of repository of Model\Image document.
 */
abstract class ImageRepository extends \Mongator\Repository
{
    ...
    {
        $this->documentClass = 'Model\Image';
        $this->isFile = true;
        $this->collectionName = 'model_image';
