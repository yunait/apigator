...
/**
 * Base class of query of Model\InitializeArgs document.
 */
abstract class InitializeArgsQuery extends \Mongator\Query\Query
{
     ...
     *
     * @return Model\InitializeArgsQuery The query with added criteria (fluent interface).
     */
