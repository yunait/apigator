...
/**
 * Base class of repository of Model\InitializeArgs document.
 */
abstract class InitializeArgsRepository extends \Mongator\Repository
{
    ...
    {
        $this->documentClass = 'Model\InitializeArgs';
        $this->isFile = false;
        $this->collectionName = 'model_initializeargs';
