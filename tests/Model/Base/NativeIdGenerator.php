...
/**
 * Base class of Model\NativeIdGenerator document.
 */
abstract class NativeIdGenerator extends \Mongator\Document\Document
{
     ...
     *
     * @return \Model\NativeIdGenerator The document (fluent interface).
     */
