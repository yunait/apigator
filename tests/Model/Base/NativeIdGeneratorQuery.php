...
/**
 * Base class of query of Model\NativeIdGenerator document.
 */
abstract class NativeIdGeneratorQuery extends \Mongator\Query\Query
{
     ...
     *
     * @return Model\NativeIdGeneratorQuery The query with added criteria (fluent interface).
     */
