...
/**
 * Base class of repository of Model\NativeIdGenerator document.
 */
abstract class NativeIdGeneratorRepository extends \Mongator\Repository
{
    ...
    {
        $this->documentClass = 'Model\NativeIdGenerator';
        $this->isFile = false;
        $this->collectionName = 'model_nativeidgenerator';
