...
/**
 * Base class of Model\NoneIdGenerator document.
 */
abstract class NoneIdGenerator extends \Mongator\Document\Document
{
     ...
     *
     * @return \Model\NoneIdGenerator The document (fluent interface).
     */
