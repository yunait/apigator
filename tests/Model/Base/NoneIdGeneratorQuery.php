...
/**
 * Base class of query of Model\NoneIdGenerator document.
 */
abstract class NoneIdGeneratorQuery extends \Mongator\Query\Query
{
     ...
     *
     * @return Model\NoneIdGeneratorQuery The query with added criteria (fluent interface).
     */
