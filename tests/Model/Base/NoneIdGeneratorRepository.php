...
/**
 * Base class of repository of Model\NoneIdGenerator document.
 */
abstract class NoneIdGeneratorRepository extends \Mongator\Repository
{
    ...
    {
        $this->documentClass = 'Model\NoneIdGenerator';
        $this->isFile = false;
        $this->collectionName = 'model_noneidgenerator';
