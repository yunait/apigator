...
/**
 * Base class of Model\SequenceIdGenerator document.
 */
abstract class SequenceIdGenerator extends \Mongator\Document\Document
{
     ...
     *
     * @return \Model\SequenceIdGenerator The document (fluent interface).
     */
