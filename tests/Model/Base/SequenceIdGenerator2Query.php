...
/**
 * Base class of query of Model\SequenceIdGenerator2 document.
 */
abstract class SequenceIdGenerator2Query extends \Mongator\Query\Query
{
     ...
     *
     * @return Model\SequenceIdGenerator2Query The query with added criteria (fluent interface).
     */
