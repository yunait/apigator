...
/**
 * Base class of repository of Model\SequenceIdGenerator2 document.
 */
abstract class SequenceIdGenerator2Repository extends \Mongator\Repository
{
    ...
    {
        $this->documentClass = 'Model\SequenceIdGenerator2';
        $this->isFile = false;
        $this->collectionName = 'model_sequenceidgenerator2';
