...
/**
 * Base class of query of Model\SequenceIdGeneratorDescending document.
 */
abstract class SequenceIdGeneratorDescendingQuery extends \Mongator\Query\Query
{
     ...
     *
     * @return Model\SequenceIdGeneratorDescendingQuery The query with added criteria (fluent interface).
     */
