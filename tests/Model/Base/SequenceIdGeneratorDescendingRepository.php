...
/**
 * Base class of repository of Model\SequenceIdGeneratorDescending document.
 */
abstract class SequenceIdGeneratorDescendingRepository extends \Mongator\Repository
{
    ...
    {
        $this->documentClass = 'Model\SequenceIdGeneratorDescending';
        $this->isFile = false;
        $this->collectionName = 'model_sequenceidgeneratordescending';
