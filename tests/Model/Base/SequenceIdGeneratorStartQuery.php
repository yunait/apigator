...
/**
 * Base class of query of Model\SequenceIdGeneratorStart document.
 */
abstract class SequenceIdGeneratorStartQuery extends \Mongator\Query\Query
{
     ...
     *
     * @return Model\SequenceIdGeneratorStartQuery The query with added criteria (fluent interface).
     */
