...
/**
 * Base class of repository of Model\SequenceIdGeneratorStart document.
 */
abstract class SequenceIdGeneratorStartRepository extends \Mongator\Repository
{
    ...
    {
        $this->documentClass = 'Model\SequenceIdGeneratorStart';
        $this->isFile = false;
        $this->collectionName = 'model_sequenceidgeneratorstart';
            ...
            foreach ($inserts as $oid => $document) {
                ...
                if (
                    ...
                    $repository
                        ...
                        ->insert(array('_id' => $repository->getCollectionName(), 'sequence' => 2000)
                    );
                    $data['_id'] = 2000;
                }
