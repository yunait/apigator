...
/**
 * Base class of query of Model\TextTextElement document.
 */
abstract class TextTextElementQuery extends \Mongator\Query\Query
{
    ...
    public function createCursor()
    {
        ...
        $criteria = array_merge($criteria, array('type' => 'texttextelement'));
     ...
     *
     * @return Model\TextTextElementQuery The query with added criteria (fluent interface).
     */
    ...
    /**
     * Find by "text_text" field.
     *
     * @param mixed $value The value.
     *
     * @return Model\TextTextElementQuery The query with added criteria (fluent interface).
     */
    public function findByText_text($value)
    {
        $castValue = (string) $value;
        if ($castValue !== $value) throw new \Exception('Bad value: type string expected');
        
        return $this->mergeCriteria(array('text_text' => $castValue ));
    }
