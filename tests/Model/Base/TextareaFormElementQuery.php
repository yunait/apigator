...
/**
 * Base class of query of Model\TextareaFormElement document.
 */
abstract class TextareaFormElementQuery extends \Mongator\Query\Query
{
    ...
    public function createCursor()
    {
        ...
        $criteria = array_merge($criteria, array('type' => 'textarea'));
     ...
     *
     * @return Model\TextareaFormElementQuery The query with added criteria (fluent interface).
     */
    ...
    /**
     * Find by "default" field.
     *
     * @param mixed $value The value.
     *
     * @return Model\TextareaFormElementQuery The query with added criteria (fluent interface).
     */
    public function findByDefault($value)
    {
        $castValue = (string) $value;
        if ($castValue !== $value) throw new \Exception('Bad value: type string expected');
        
        return $this->mergeCriteria(array('default' => $castValue ));
    }
