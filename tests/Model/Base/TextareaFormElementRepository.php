...
/**
 * Base class of repository of Model\TextareaFormElement document.
 */
abstract class TextareaFormElementRepository extends \Mongator\Repository
{
    ...
    {
        $this->documentClass = 'Model\TextareaFormElement';
        $this->isFile = false;
    ...
    {
        $query = array_merge($query, array('type' => 'textarea'));
