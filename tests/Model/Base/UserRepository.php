...
/**
 * Base class of repository of Model\User document.
 */
abstract class UserRepository extends \Mongator\Repository
{
    ...
    {
        $this->documentClass = 'Model\User';
        $this->isFile = false;
        $this->collectionName = 'model_user';
